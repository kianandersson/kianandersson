...
The full 11-step ramp per family (50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950) is generated by `oklch(L% C H)` with the shared L ladder `[97.5, 95, 90, 82.5, 72.5, 62.5, 52.5, 42.5, 35, 27.5, 20]` and a per-family chroma curve (peaks at the mid-steps, tapers at the ends to stay in gamut). The chroma curves:
